...
// NOTE: Azure has a list of reserved usernames that cannot be used.
// Run ./validate-username.sh <username> to check before deployment.
// Common reserved names include: administrator, admin, root, guest, test, user, etc.
